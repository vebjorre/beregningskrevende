...
We observe that the mean $(\bar{\lambda}_0^*, \bar{\lambda}_1^*)=(3.91,6.49)$ of the bootstrap samples does not correspond well with the maximum likelihood estimates $(\lambda_{0}, \lambda_{1})=(3.47,9.35)$, and that the whole distribution looks skewed. This corresponds to the large bias in the print out , and it may therefore be appropriate to use the bias correctd estimates for $\lambda_0$ and $\lambda_1$. 
...
```
We see that the bias corrected estimates for $\lambda_0$ and $\lambda_1$ correspond well with the maximum likelihood estimates $(\lambda_{0}, \lambda_{1})=(3.47,9.35)$. In this case, therefore, it will not matter which one we choose to use. 
