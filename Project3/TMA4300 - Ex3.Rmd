...
```
We see that the estimates for $\lambda_0$ and $\lambda_1$ correspond well with the maximum likelihood estimates $(\lambda_{0}, \lambda_{1})=(3.4657,9.3532)$ after we have correct for the bias, and with a large number of samples does not the variance affect the estimate.
